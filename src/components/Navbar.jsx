...
export default function Navbar() {
  ...
  // Close the mobile sidebar automatically if the viewport is resized back to desktop
  useEffect(() => {
  ...
  return (
    <>
      {/* Mobile top bar — only visible under 900px via CSS */}
      ...
      {/* Backdrop, only rendered while the mobile sidebar is open */}
      ...
      >
        ...
        >
          ...
          {!collapsed && <span style={{ fontSize: 19, fontWeight: 700 }}>Swiss Bank</span>}
        </div>
